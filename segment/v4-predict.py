...
#         cv2.putText(im0, str(a), (int(align_right),align_bottom), cv2.FONT_HERSHEY_SIMPLEX, 1,(255,255,255),1,cv2.LINE_AA)
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det[:, :6]):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        # cv2.putText(im0, f"Real-Time Count: {len(det)}", (100, 105), cv2.FONT_HERSHEY_TRIPLEX, 12, (0, 0, 0), 2)
                        # cv2.putText(im0, f"{s}", (100, 105), cv2.FONT_HERSHEY_TRIPLEX, 12, (255, 0, 0), 2)
